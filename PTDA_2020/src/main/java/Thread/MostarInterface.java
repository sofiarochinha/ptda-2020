 ...
 * @author sofia
 */
public class MostarInterface extends Thread{
    
    JFrame atual;
    JFrame posterior;

    public MostarInterface(JFrame atual, JFrame posterior) {
        this.atual = atual;
    ...
    public void Interface(JFrame atual, JFrame posterior) throws InterruptedException{
        ...
        System.out.println(posterior.getName());
        
        
        if(!posterior.getName().equals("frame0")){ 
     ...
     public void run() {
        ...
        try {
            ...
            Logger.getLogger(MostarInterface.class.getName()).log(Level.SEVERE, null, ex);
        }
  }
